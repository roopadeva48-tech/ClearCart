...
export default function Navbar({
  ...
  return (
    <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-slate-200/80 px-4 sm:px-8 py-3 flex items-center justify-between gap-4 transition-all">
      {/* Brand */}
        ...
        <div>
          <div className="flex items-center gap-2">
            <span className="font-heading font-extrabold text-xl tracking-tight text-slate-900">
              Clear<span className="text-indigo-600">Cart</span>
            </span>
            <span className="hidden sm:inline-flex items-center gap-1 text-[11px] font-semibold font-mono bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded-full border border-emerald-200">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative flex items-center bg-slate-100/90 border border-slate-200 rounded-xl px-3 py-1.5 w-44 sm:w-64 focus-within:w-72 focus-within:bg-white focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-100 transition-all">
        ...
        <div className="hidden sm:flex items-center gap-2.5 pl-2 border-l border-slate-200">
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-indigo-600 to-violet-500 flex items-center justify-center text-xs font-bold text-white shadow-xs">
            SM
          </div>
